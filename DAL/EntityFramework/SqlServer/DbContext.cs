...
namespace ProjectQ.DAL.EntityFramework.SqlServer
{
    public class DbContext : ProjectQEntities
    {
        ...
        {
#if DEBUG
            ConnectionString = "Data Source=.;Initial Catalog=ProjectQ;Integrated Security=True;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=False;Connect Timeout=60;Encrypt=False;TrustServerCertificate=True";
#else
